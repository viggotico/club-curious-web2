        ...
        <div className={style.main}>
            ...
            <div className={style.about}>
                ...
                <div className={style.left}>
                    ...
                    <a href="../events"><button>Se vores events her!</button></a>
                </div>
                <div className={style.right}>
                    <div className={style.blob} style={{backgroundImage: `url("img/ClubCurious-03236.jpg")` }}></div>
                </div>
            </div>
            <div className={style.textPath}>
                <svg id="text-container" viewBox="0 0 1000 200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text y="40" fontSize="45">
                        <textPath id="text-path" href="#text-curve" startOffset={0} fill="#BD1A1A">
